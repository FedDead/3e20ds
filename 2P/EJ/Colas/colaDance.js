...
maleDancers.enqueue(new bailadores("Pepe","M"));    //Definimos el primer hombre que estara dentro de nuestra cola para bailadores hombres
maleDancers.enqueue(new bailadores("Paco","M"));
maleDancers.enqueue(new bailadores("Luis","M"));
maleDancers.enqueue(new bailadores("Sergio","M"));

femaleDancers.enqueue(new bailadores("Eneli", "F"));    //Definimos la primer mujer que estara dentro de nuestra cola para bailadores hombres
femaleDancers.enqueue(new bailadores("Candelaria", "F"));
femaleDancers.enqueue(new bailadores("Rocio", "F"));
femaleDancers.enqueue(new bailadores("Lucy", "F"));
femaleDancers.enqueue(new bailadores("Ana", "F"));
